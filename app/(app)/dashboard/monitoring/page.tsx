...
function PushFastFollow() {
  return <section className="rg-card mb-8 border-blue-200 bg-blue-50/60" aria-labelledby="push-heading"><p className="rg-kicker">Delivery channels</p><h2 id="push-heading" className="mt-2 text-2xl font-extrabold">In-app + monthly email are live; push is next</h2><p className="mt-3 text-slate-700">Urgent personalized alerts are now marked for web push delivery in the alert pipeline. Browser Push API subscription capture, service-worker registration, and per-user subscription storage are scoped as a fast-follow so today&apos;s in-app feed and monthly email stay reliable.</p></section>;
}
...
export default async function MonitoringPage() {
  ...
  return <div className="mx-auto max-w-6xl py-8"><div className="mb-8"><Eyebrow>Retirement Watch</Eyebrow><h1 className="mt-3 text-4xl font-extrabold sm:text-5xl">Monitoring</h1></div><AlertFeed alerts={alerts} /><PushFastFollow /><TrustedContacts contacts={trustedContactsResult.data ?? []} /></div>;
}

    ...
    <div className="rg-page-shell">
      <article className="mx-auto max-w-3xl px-4 py-12 text-lg leading-8 text-slate-700 sm:py-16">
        <div className="rg-card">
          ...
          <p className="mb-6">
            This Privacy Policy explains how American Signal Media, LLC (&quot;RetireShield,&quot; &quot;we&quot;)
            collects, uses, and shares information when you use the RetireShield website and services (the &quot;Service&quot;).
          </p>
          ...
          <ul className="mb-6 list-disc space-y-3 pl-6">
            <li>
              <strong>Information you give us:</strong> your email address and the answers you enter into the Safety
              Score quiz (such as age, retirement status, income and expense ranges, savings range, and your state). We
              do not ask for account numbers or sensitive identifiers, and we do not link to your financial accounts.
            </li>
            <li>
              <strong>Usage information:</strong> basic analytics about how you use the site (pages viewed, actions
              taken), collected to measure and improve the Service.
            </li>
          </ul>

          <h2 className="mt-10 mb-4 text-2xl font-bold text-ink">2. How we use your information</h2>
          <p className="mb-6">
            To generate your Retirement Safety Score, send you the emails you opt into (which you can unsubscribe from at
            any time), measure and improve the Service, and meet our legal obligations.
          </p>
          ...
          <ul className="mb-6 list-disc space-y-3 pl-6">
            <li><strong>Supabase</strong> — secure database.</li>
          ...
          <p className="mb-6">
            We use cookies and similar technologies for essential functionality and analytics. You can control cookies
            through your browser settings.
          </p>

          <h2 className="mt-10 mb-4 text-2xl font-bold text-ink">5. Email choices</h2>
          <p className="mb-6">
            You can unsubscribe from our emails at any time using the link in any message. We may still send you
            service-related messages, such as security notices, where permitted.
          </p>

          <h2 className="mt-10 mb-4 text-2xl font-bold text-ink">6. Data retention</h2>
          <p className="mb-6">
            We keep your information for as long as needed to provide the Service and meet our legal obligations, then

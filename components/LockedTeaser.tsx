...
export default function LockedTeaser({ eyebrow = "Premium", title, description, children }: LockedTeaserProps) {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm shadow-slate-200/70">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-6">
        <div className="max-w-xl rounded-2xl border border-brand/20 bg-white/95 p-6 text-center shadow-xl shadow-brand/10">

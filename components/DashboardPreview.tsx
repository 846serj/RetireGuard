...
export default function DashboardPreview() {
  return (
    <section
      ...
      className="min-h-[480px] w-full overflow-hidden rounded-3xl border border-slate-200 bg-surface shadow-[0_20px_50px_-24px_rgba(22,58,102,0.45)]"
    >
      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[1.5fr_1fr]">
        <div className="space-y-4">
          ...
          <article className="rounded-2xl border border-slate-200 border-l-4 border-l-brand bg-white p-5 shadow-sm shadow-slate-200/70">
            <p className="text-xs font-bold uppercase text-brand">Medicare</p>
            <h3 className="mt-2 text-xl font-semibold text-ink">An IRMAA line is close</h3>
        ...
        <aside className="flex min-h-[440px] flex-col rounded-2xl bg-band p-4">
          <div className="flex items-center gap-2 text-sm font-extrabold text-ink">
